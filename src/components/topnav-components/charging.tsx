    ...
    >
      <div className="relative flex flex-row items-start justify-center">
        {chargers.map((charger, key) => {
          return (
            <div
              className="relative flex flex-col items-center justify-center mx-10 mt-4"
              key={key}
            >
              <img src={charger.image} alt="" className="relative h-32 w-32 " />
        ...
        <div className="relative h-56 border-l-[2px] border-gray-300 ml-16"></div>
        <div className="relative flex flex-col item-start justify-start pl-16 mt-2 mr-32">
          {chargerOptions.map((option, key) => {
            return (
              <a
                href="#"
                key={key}
...
const chargers = [
  ...
  { title: "Home Charging", image: home_charging },
  { title: "Supercharging", image: powerwall },
];
